...
function preload() 
{
  bg1 = loadImage('res\\exercise2\\bg1.png')
  bg2 = loadImage('res\\exercise2\\bg2.png')
 // bg3 = loadImage('art\\bg3.png')

  bearBlow = createSprite(1400,700)
  bearBlow.addAnimation('blowing','res\\exercise2\\bearBlow1.png','res\\exercise2\\bearBlow2.png','res\\exercise2\\bearBlow3.png','res\\exercise2\\bearBlow4.png','res\\exercise2\\bearBlow5.png','res\\exercise2\\bearBlow6.png')

  //---ui

  logo = createSprite(400,200)
  logo.addAnimation('idle','res\\exercise2\\logo.png')

  startGameButton = createSprite(300,200)
  startGameButton.addAnimation('idle','res\\exercise2\\button1.png')

  exitButton = createSprite(300,200)
  exitButton.addAnimation('idle','res\\exercise2\\button2.png')

  retryButton = createSprite(300,200)
  retryButton.addAnimation('idle','res\\exercise2\\button3.png')
  //------------
  ...
  for (var i = 0; i< num; i++) {
    ...
    bubbleArray[i].addAnimation('normal','res\\exercise2\\bubbleAnim1.png')
    bubbleArray[i].addAnimation('popping','res\\exercise2\\bubbleAnim1.png','res\\exercise2\\bubbleAnim5.png')
  ...
  crosshair.addAnimation('normal', 'res\\exercise2\\crosshair.png')
  crosshair.changeAnimation('normal')
 
  startSound = loadSound('res\\exercise2\\tring.mp3')
  popSound = loadSound('res\\exercise2\\pop.mp3')
  overSound = loadSound('res\\exercise2\\wow.mp3')
  ost = loadSound('res\\exercise2\\theme.mp3')
